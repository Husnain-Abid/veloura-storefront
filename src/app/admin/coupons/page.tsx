  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        ...
        <Link href="/admin/coupons/new" className="bg-black text-white px-6 py-4 rounded-lg text-xs font-bold uppercase tracking-widest flex items-center gap-2">
        ...
        {loading ? (
          ...
          <div key={coupon.id} className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm space-y-4">
             ...
             <div className="flex justify-end gap-2 pt-4 border-t border-gray-50">
                <Link href={`/admin/coupons/${coupon.id}`} className="p-2 hover:bg-gray-100 rounded transition-colors"><Edit2 className="w-4 h-4 text-gray-400" /></Link>
