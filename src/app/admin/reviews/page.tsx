        ...
        {loading ? (
          ...
          <div key={review.id} className="bg-white p-8 rounded-xl border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-start">
            <div className="w-16 h-20 bg-gray-50 shrink-0">
              ...
              <img src={review.product?.images?.[0]?.url || "/placeholder.jpg"} className="w-full h-full object-cover" alt={review.product?.name || "Product"} />
            ...
            <div className="flex-1 space-y-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-xs text-gray-400 uppercase tracking-widest">On {review.product?.name || "Unknown Product"}</p>
