...
const ProductVariantSchema = new Schema(
  {
    ...
    /*
     * IMPORTANT:
     * Images belonging to this specific color.
     */
    images: {
    ...
    /*
     * Stock for each size of this color.
     */
    sizes: {
...
const ProductSchema = new Schema(
  {
    ...
    /*
     * Total stock.
     * When variants exist, this should be
     * calculated from variant sizes.
     */
    stock: {
      type: Number,
      default: 0,
